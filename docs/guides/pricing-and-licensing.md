...
| | Free | Pro |
|---|---|---|
| **Price** | $0 forever | $59/yr or $7.99/mo |
| Smart Scan (10 AI clients) | ✓ | ✓ |
| Dashboard & health score | ✓ | ✓ |
| Local recommendations | ✓ | ✓ |
| Versioned backups (view, compare, export) | ✓ | ✓ |
| Token Hygiene (7-day snapshot) | ✓ | ✓ |
| Live session watcher | | ✓ |
| 9 waste-pattern detectors | | ✓ |
| Weekly TokenDiet digest | | ✓ |
| 30-day per-project drill-down | | ✓ |
| AI-powered recommendations | | ✓ |
| Contradiction detection | | ✓ |
| Batch cleanup | | ✓ |
| Config profiles | | ✓ |
| Scheduled scans | | ✓ |
| Backup restore & ZIP import | | ✓ |

The free tier is a complete product, not a teaser. Scan, review, clean up manually, and keep versioned backups — all free, forever.
...
**14-day unconditional refund** on the first charge. No questions asked. Request via [getnaqi.com/refund](https://getnaqi.com/refund) or email support@getnaqi.com.
